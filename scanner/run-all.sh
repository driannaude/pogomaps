...
sleep 5
python ./runserver.py -a google -u pokegochchsumner@gmail.com -p sumnerpikachu -P 9002 -l "2 Esplanade, Sumner, Christchurch" -k AIzaSyAHQzPUK1wJ3peAUqkxLyjTsWbceFwCB9A -st 10 -D "sumner.db" &
sleep 5
...
sleep 5
python ./runserver.py -a google -u pokechchhalswell@gmail.com -p halswellmagmar -P 9013 -l "339 Halswell Road, Halswell, Christchurch, New Zealand" -k AIzaSyB1xmk0SgauBGotpGglRs6DOohSzNGUw -st 10 -D "halswell.db" &
sleep 5
# 24 July
python ./runserver.py -a google -u pokegochchhoonhay@gmail.com -p hoonhaytauros -P 9014 -l "7 Victors Road, Hoon Hay, Christchurch, New Zealand" -k AIzaSyA2A1kje7HO8DtBeQBbMiHZZOwEv0VKKys -st 10 -D "hoonhay.db" &
sleep 5
python ./runserver.py -a google -u pokegochchlyttleton@gmail.com -p lyttletonparas -P 9015 -l "31 Dublin Street, Lyttleton, Canterbury, New Zealand" -k AIzaSyCAgduipjLdkyorazQx6dPqv28yPu4VJbg -st 10 -D "lyttleton.db" &
sleep 5
python ./runserver.py -a google -u pokegochchstalbans@gmail.com -p stalbansgastly -P 9016 -l "135 St Albans Street, St Albans, Christchurch, New Zealand" -k AIzaSyD0ruzhcWld88TjgO3wk6UHW2I7ri39kmw -st 8 -D "stalbans.db" &
sleep 5
python ./runserver.py -a google -u pokegochchedgeware@gmail.com -p edgewarediglet -P 9017 -l "141 Geraldine Street, Edgeware, Christchurch, New Zealand" -k AIzaSyBliWjoFcK446h3SLFp7K0ttnjVDdXG33g -st 8 -D "edgeware.db" &
sleep 5
python ./runserver.py -a google -u pokegochchsydenham@gmail.com -p sydenhampsyduck -P 9018 -l "28 Hastings Street, Sydenham, Christchurch, New Zealand" -k AIzaSyA7ixGRFEqb5WGzZmhiDwszob1Ax_Bey8Q -st 8 -D "sydenham.db" &
sleep 5
python ./runserver.py -a google -u pokegochchspreydon@gmail.com -p spreydonmagnemite -P 9019 -l "66 Rahera Street, Spreydon, Christchurch, New Zealand" -k AIzaSyARICSuBlUcouyOsL7f5hetUfjdlVK4AWg -st 10 -D "spreydon.db" &
sleep 5
python ./runserver.py -a google -u pokegochchsomerfield@gmail.com -p somerfielddoduo -P 9020 -l "146 Rose Street, Somerfield, Christchurch, New Zealand" -k AIzaSyC0ELD5POR1i3xbyQFnG6Lr2LwDB-dwbeE -st 8 -D "somerfield.db" &
sleep 5
...
sleep 5
python ./runserver.py -a google -u pokegochchpapanui@gmail.com -p papanuiratatta -P 9024 -l "2 Harewood Road, Papanui, Christchurch, New Zealand" -k AIzaSyDeDYCnYuII181rBh8Jxk2YpiLOupvkJoc -st 10 -D "papanui.db" &
